...
export default function Settings() {
	...
	const [addingType, setAddingType] = useState<"frequent" | "sos" | null>(
		null,
	);
	...
	const deleteSosContact = (id: string) => {
		Alert.alert(
			"Delete SOS Contact",
			"Are you sure you want to delete this SOS contact?",
			[
				{ text: "Cancel", style: "cancel" },
				{
					text: "Delete",
			...
			<ScrollView className="flex-1">
				<View className="px-6 py-8">
					...
					<View className="mb-8">
						...
						{frequentContacts.map((contact) => (
							...
							>
								...
								<TouchableOpacity
									onPress={() => deleteFrequentContact(contact.id)}
								>
									<Ionicons
										name="trash"
										size={24}
					...
					<View className="mb-8">
						...
						<Text className="text-muted-foreground mb-4 text-sm">
							These contacts will receive emergency alerts when you press the
							SOS button
						</Text>
